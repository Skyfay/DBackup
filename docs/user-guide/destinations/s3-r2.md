...
| **Login** | `ACCESS_KEY` credential profile (R2 API token Access Key ID + Secret) | - | ✅ |
...
6. Enter Account ID and Bucket, select the **Jurisdiction** matching your bucket, then pick the credential profile under **Login**
