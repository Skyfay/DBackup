...
INSERT INTO "new_Job" ("compression", "createdAt", "destinationId", "enabled", "encryptionProfileId", "id", "name", "retention", "schedule", "sourceId", "updatedAt") SELECT "compression", "createdAt", "destinationId", "enabled", "encryptionProfileId", "id", "name", "retention", "schedule", "sourceId", "updatedAt" FROM "Job";
DROP TABLE "Job";
