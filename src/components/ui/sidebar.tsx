...
/**
 * Shadcn sidebar (new-york-v4), adapted to DBackup:
 *
 * - The collapsed state lives in its own `dbackup_sidebar_state` cookie, so another shadcn app on the
...
const SIDEBAR_COOKIE_NAME = "dbackup_sidebar_state"
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  // Radix wraps the viewport content in a `display: table` div that grows with its widest child.
  // Forcing it to a block keeps long labels truncating inside the sidebar width.
  return (
