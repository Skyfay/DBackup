...
features:
  ...
  - icon: 📊
    ...
    details: A health banner that names the failing job, trend cards, live lists of runs and jobs, storage per destination, and a Backup Calendar that grows with the screen. Works on a phone too.
  - icon: 🗂️
