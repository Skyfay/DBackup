...
import { Bell, CalendarClock, Database, HardDrive, Layers, Loader2, Lock, Pencil, Plus, Shrink, SlidersHorizontal, type LucideIcon } from "lucide-react";
...
import { IncrementalPart } from "./job-part-incremental";
...
export function JobForm({ sources: loadedSources, destinations, directorySourceOptions: loadedFolders, notifications, encryptionProfiles, initialData, onSaved, onConnectionAdded }: JobFormProps) {
    ...
    const body = (id: JobPartId) => {
        switch (id) {
            ...
            case "incremental":
                return <IncrementalPart sources={sources} folderOptions={directorySourceOptions} />;
            case "destinations":
