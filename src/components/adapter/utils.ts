...
import { Database, Folder, HardDrive, MessageSquare, Mail, Disc, Network } from "lucide-react";
...
export function getAdapterIcon(adapterId: string) {
    ...
    if (id.includes('smb') || id.includes('samba') || id.includes('sftp')) return Network;
